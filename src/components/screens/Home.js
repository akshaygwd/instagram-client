...
const Home = () => {
  ...
  useEffect(() => {
    fetch('https://instgramserver.herokuapp.com/posts', {
      headers: {
                    ...
                    return (
                      ...
                      <h6>
                        ...
                        { record.postedBy._id == state._id &&
                          <i className="material-icons right" style={{color: "black", display:'block', cursor:"pointer"}} onClick={()=>{deleteComment(record._id, item._id)}}>deleter</i>
                        }
                      </h6>
